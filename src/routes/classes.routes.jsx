...
export const classesRoutes = (
  <>
    <Route
      ...
      element={
        <RequireAuth loginPath="/">
          <RequirePermission module="classes" operation="read">
            <Classes_List />
          </RequirePermission>
        </RequireAuth>
      }
    ...
    <Route
      ...
      element={
        <RequireAuth loginPath="/">
          <RequirePermission module="classes" operation="add">
            <Classes_Add />
          </RequirePermission>
        </RequireAuth>
      }
    ...
    <Route
      path="/school/classes/:id/schedule"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission module="classes" operation="read">
            <Classes_Schedule />
