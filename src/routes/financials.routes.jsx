...
export const financialsRoutes = (
  <>
    ...
    <Route
      path="/financial/fee-configs/add"
      element={
    ...
    <Route
      path="/financial/fee-configs/edit/:id"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/installment-plans/add"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/installment-plans/edit/:id"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/all-records/:studentId"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/records/:studentId"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/records/me/summary"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/discounts/edit/:id"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/additional-fees"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/additional-fees/add"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/records/:studentId/bus"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/trips/:tripTemplateId"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/records/:studentId/trips"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
    ...
    <Route
      path="/financial/records/:studentId/trips/add"
      element={
        <RequireAuth loginPath="/">
          <RequirePermission
            module="financial"
