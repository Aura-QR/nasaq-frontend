...
export const addStudent = async (
  ...
  try {
    ...
    /*
     * مهم: POST /students في الباك ينفذ automatic enrollment إذا استقبل classId،
     * وهذا يجعل إنشاء الطالب يفشل بالكامل عند وجود أي مشكلة في FeeConfig.
     * لذلك إنشاء الطالب هنا مستقل دائماً، والربط بالفصل يتم عبر /enrollments.
     */
